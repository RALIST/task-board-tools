...
|----|-------|----------|--------|--------|
| TB-93 | Move from file-based to folder-based approach | 16/42 | backlog | cli |
...
| TB-146 | TB-93/CLI: attach promotion orphans file-form agent state + logs | bug | P0 | M | cli |
...
| TB-155 | TB-93/GUI: attachmentsLoading flicker on rapid task switch and concurrent refresh race | bug | P1 | S | gui |
...
| TB-158 | TB-93/GUI: insert '--' before user paths in tb attach mutations to prevent flag confusion | bug | P2 | S | gui |
...
| TB-202 | Create proper name and icon for app | improvement | P2 | S |  |
